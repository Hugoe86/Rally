<%@ Page Title="Catálogo de Turnos" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master"
    AutoEventWireup="true" CodeBehind="Frm_Tra_Cat_Turnos.aspx.cs" 
    Inherits="web_trazabilidad.Paginas.Catalogos.Frm_Tra_Cat_Turnos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../../Recursos/bootstrap-timepicker/bootstrap-timepicker.css" rel="stylesheet" />
    <script src="../../Recursos/bootstrap-timepicker/bootstrap-timepicker.js"></script>
    <script src="../../Recursos/bootstrap-table/locale/bootstrap-table-es-MX.min.js"></script>
    <script src="../../Recursos/javascript/seguridad/Js_Controlador_Sesion.js"></script>
    <script src="../../Recursos/javascript/catalogos/Js_Tra_Cat_Turnos.js"></script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid" style="height:100vh;">
        ...
        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Turnos</h3>
        </div>
        ...
        <table id="tbl_turnos" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>
