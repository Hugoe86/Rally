<%@ Page Language="C#" Title="Familias" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Tra_Cat_Familias.aspx.cs" Inherits="web_trazabilidad.Paginas.Catalogos.Frm_Tra_Cat_Familias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Tra_Cat_Familias.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height:100vh;">
        ...
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Familias</h3>
        </div>
        ...
        <div class="panel panel-color panel-info collapsed" id="panel1">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <input type="text" id="txt_busqueda_por_clave" class="form-control" placeholder="Búsqueda por clave" />
                    </div>
                     <div class="col-md-1" style="margin-top: 8px;">
                        <label>Estatus</label>
                    </div>
        ...
        <table id="tbl_familias" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>