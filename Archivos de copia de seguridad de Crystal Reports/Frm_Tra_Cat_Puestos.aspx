<%@ Page Title="Catálogo de Puestos" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Tra_Cat_Puestos.aspx.cs" Inherits="web_trazabilidad.Paginas.Catalogos.Frm_Tra_Cat_Puestos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Tra_Cat_Puestos.js"></script>
</asp:Content>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                   ...
                   <div class="col-md-1" style="margin-top: 8px;">
                    ...
                    <div class="col-md-2" style="margin-top: 6px !important;" align="right">
