<%@ Page Title="Catálogo de Tipos Transacciones" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Tra_Com_Cat_Tipos_Transacciones.aspx.cs" Inherits="web_trazabilidad.Paginas.Catalogos.Frm_Tra_Com_Cat_Tipos_Transacciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Tra_Com_Cat_Tipos_Transacciones.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container-fluid" style="height:100vh;">

        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Tipos Transacciones</h3>
        </div>
        ...
        <div class="panel panel-color panel-info collapsed" id="panel1">
            ...
            <div class="panel-body">
                <div class="row">
                     <div class="col-md-1 vertical-align-label">
                        <label>Nombre</label>
                    </div>
                    <div class="col-md-3">
        ...
        <table id="tbl_tipos_transacciones" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>
