<%@ Page Language="C#" title="Departamentos" AutoEventWireup="true" CodeBehind="Frm_Cat_Nom_Departamentos.aspx.cs" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" Inherits="web_trazabilidad.Paginas.Nomina.Frm_Cat_Nom_Departamentos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/nomina/Js_Cat_Nom_Departamentos.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        ...
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Departamentos.</h3>
        </div>

        <div id="Cat_Nom_Departamentos_Principal"></div>
        <div id="Cat_Nom_Departamentos_Operacion">
