<%@ Page Language="C#" Title="Reporte de existencias"  MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Rpt_Existencias.aspx.cs" Inherits="web_trazabilidad.Paginas.Reporting.Frm_Rpt_Existencias" %>
...
<link href="../../Recursos/bootstrap-table/bootstrap-table.min.css" rel="stylesheet" />
    ...
    <script src="../../Recursos/javascript/Reporting/Js_Rpt_Existencias.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height:100vh;">

        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Reporte de existencias</h3>
        </div>
        ...
        <div class="panel panel-color panel-info" id="panel1">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                       <label class="fuente_lbl_controles">No. Contenedor</label>
                        <input type="text" id="txt_no_contenedor" class="form-control" placeholder="No. Contenedor" />
                    </div>
                    <div class="col-md-2">
                      <label class="fuente_lbl_controles" style="margin-bottom: 8px;" for="cmb_ubicacion">Almacén</label>
                      <select id="cmb_almacen_ubicacion"></select>
                    </div>
                    <div class="col-md-2">
                       <label class="fuente_lbl_controles" style="margin-bottom: 8px;" for="cmb_ubicacion">Almacén Ubicación</label>
