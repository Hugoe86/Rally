<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Tra_Cat_Empleados.aspx.cs" Inherits="web_trazabilidad.Paginas.Catalogos.controllers.Frm_Tra_Cat_Empleados" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Tra_Cat_Empleados.js"></script>
          ...
          <div class="panel panel-color panel-info collapsed" id="panel1">
            ...
            <div class="panel-body">
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3">
                        <input type="text" id="txt_busqueda_por_clave" class="form-control" placeholder="Busqueda por clave" maxlength="5" />
                    </div>
