<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Cat_Nom_Tipo_Contratos.aspx.cs" Inherits="web_trazabilidad.Paginas.Nomina.Frm_Cat_Nom_Tipo_Contratos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/nomina/Js_Cat_Nom_Tipo_Contratos.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="container-fluid" style="height: 100vh;">

        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Tipos de Contratos.</h3>
        </div>

        <div id="Tipo_Contratos_Principal"></div>
        <div id="Tipo_Contratos_Operacion"></div>
