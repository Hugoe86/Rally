<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Ope_Ordenes_Cliente.aspx.cs" Inherits="web_trazabilidad.Paginas.Trazabilidad.Frm_Ope_Ordenes_Cliente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/bootstrap-table/extensions/editable/bootstrap-editable.js"></script>
    <script src="../../Recursos/bootstrap-table/extensions/editable/bootstrap-table-editable.js"></script>--%>
    ...
    <script src="../../Recursos/javascript/trazabilidad/Js_Ope_Ordenes_Cliente.js" type="text/javascript"></script>
    ...
    <style>
        ...
        /*[data-field="No_OC_Recibida"] .th-inner {
            width: 200px;
        }
