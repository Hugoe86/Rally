<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Ope_Listado_Orden_Produccion.aspx.cs" Inherits="web_trazabilidad.Paginas.Trazabilidad.Frm_Ope_Listado_Orden_Produccion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/trazabilidad/Js_Ope_Listado_Orden_Produccion.js"></script>
    <style>
        .datagrid-body td {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12 text-left" style="background-color: white!important;">
                    <h3>Listado de &Oacute;rdenes de Producci&oacute;n</h3>
                </div>
            </div>
        </div>
                ...
                <div id="pnl_filtros">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" id="txt_no_orden_busqueda" class="form-control" placeholder="No. Orden" style="margin: 0px;" />
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="cmb_estatus_busqueda" class="form-control"></select>
                        </div>
        ...
        <div id="div_busqueda">
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl_listado" class="easyui-propertygrid"></table>
                </div>
            </div>
        </div>
    </div>
