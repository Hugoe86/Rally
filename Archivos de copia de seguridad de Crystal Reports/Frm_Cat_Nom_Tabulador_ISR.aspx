<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Cat_Nom_Tabulador_ISR.aspx.cs" Inherits="web_trazabilidad.Paginas.Nomina.Frm_Cat_Nom_Tabulador_ISR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <%--  <link href="../../Recursos/estilos/css_percepciones_deducciones.css" rel="stylesheet" />--%>
    ...
    <script src="../../Recursos/javascript/nomina/Js_Cat_Nom_Tabulador_ISR.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        ...
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Tabulador de ISR.</h3>
        </div>

        <div id="Nom_Tabulador_ISR_Principal"></div>
        <div id="Nom_Tabulador_ISR_Operacion">
