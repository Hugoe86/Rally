<%@ Page Language="C#" Title="Nivel Estudio" AutoEventWireup="true" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" CodeBehind="Frm_Cat_Nom_Nivel_Estudio.aspx.cs" Inherits="web_trazabilidad.Paginas.Nomina.Frm_Cat_Nom_Nivel_Estudio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/nomina/Js_Cat_Nom_Nivel_Estudio.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        ...
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Nivel Estudio.</h3>
        </div>

        <div id="Cat_Nom_Nivel_Estudio_Principal"></div>
        <div id="Cat_Nom_Nivel_Estudio_Operacion">
