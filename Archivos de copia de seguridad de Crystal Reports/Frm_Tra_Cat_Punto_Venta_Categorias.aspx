<%@ Page Language="C#" Title="Catálogo de Punto de venta categorías"
     AutoEventWireup="true" 
    MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master"
    CodeBehind="Frm_Tra_Cat_Punto_Venta_Categorias.aspx.cs" 
    Inherits="web_trazabilidad.Paginas.Catalogos.Frm_Tra_Cat_Punto_Venta_Categorias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Tra_Cat_Punto_Venta_Categorias.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height:100vh;">
        ...
        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de punto de venta Categor&iacute;as
            </h3>
        </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" style="margin-top: 8px;">
                       <select id="cmb_pv_categoria_padre_filtro" name="cmb_pv_categoria_padre_filtro" style="width: 100% !important"></select> 
                    </div>
        ...
        <table id="tbl_pv_categorias" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>
