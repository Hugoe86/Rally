<%@ Page Language="C#"
    ...
    CodeBehind="Frm_Cat_Pos_Mesas.aspx.cs"
    Inherits="web_trazabilidad.Paginas.Catalogos.Frm_Cat_Pos_Mesas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Pos_Mesas.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height: 100vh;">

        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Mesas</h3>
        </div>
        ...
        <div class="panel panel-color panel-info" id="panel1">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label class="fuente_lbl_controles">No. Mesa</label>
                        <input type="text" id="txt_busqueda_por_no_mesa" class="form-control" placeholder="Busqueda por No." />
                    </div>
        ...
        <table id="tbl_mesas" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>
