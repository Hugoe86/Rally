    ...
    public class Cls_Apl_Cat_Roles_Data
    {
            ...
            try
            {
                ...
                Mi_Oracle = "INSERT INTO " +
                        ...
                        ", " + Apl_Cat_Roles.Campo_Empresa_ID +
                         ", " + Apl_Cat_Roles.Campo_Sucursal_ID +
                        ", " + Apl_Cat_Roles.Campo_Estatus_ID +
                        ", " + Apl_Cat_Roles.Campo_Nivel_ID +
                        ", " + Apl_Cat_Roles.Campo_Descripcion +
                        ", " + Apl_Cat_Roles.Campo_Tipo +
                        ", " + Apl_Cat_Roles.Campo_Usuario_Creo +
                        ", " + Apl_Cat_Roles.Campo_Fecha_Creo + ") ";
                Mi_Oracle = Mi_Oracle + "VALUES('" + Datos.P_Nombre + "', " + Datos.Empresa_ID + ", " + Datos.Sucursal_ID + ", " + Datos.Estatus_ID + ", " + Datos.Nivel_ID + ", ";
                Mi_Oracle = Mi_Oracle + "'" + Datos.P_Comentarios + "','WEB', '"   + Datos.P_Usuario_Creo + "', GETDATE())";
                ...
                Mi_Oracle = "SELECT MAX(" + Apl_Cat_Roles.Campo_Rol_ID + ") FROM " +
                    Apl_Cat_Roles.Tabla_Apl_Cat_Roles + " WHERE " + Apl_Cat_Roles.Campo_Empresa_ID + "=" + Datos.Empresa_ID.ToString() +
                    " and " + Apl_Cat_Roles.Campo_Sucursal_ID + "=" + Datos.Sucursal_ID.ToString();
                ...
                //Agregar relacion de roles sucursales 
                Mi_Oracle = "INSERT INTO Apl_Roles_Sucursales (Empresa_ID, Sucursal_ID, Rol_ID) VALUES " +
                            "( " +  Datos.Empresa_ID  + ", " + Datos.Sucursal_ID + ", " + Datos.P_Rol_ID + ")";
        ...
        public static Boolean Baja(Cls_Apl_Cat_Roles_Business Datos)
        {
            ...
            try
            {
                ...
                Mi_Oracle = "";
                Mi_Oracle = "DELETE FROM Apl_Roles_Sucursales WHERE Rol_ID = " + Datos.P_Rol_ID;
                Cmd.CommandText = Mi_Oracle;
                Cmd.ExecuteNonQuery();
                Mi_Oracle = "";
        ...
        public static DataTable Llenar_Tbl_Roles(Cls_Apl_Cat_Roles_Business Datos)
        {
            ...
            int Sucursal_ID = String.IsNullOrEmpty(Cls_Sesiones.Sucursal_ID) ? -1 : Convert.ToInt32(Cls_Sesiones.Sucursal_ID);
            try
            {
                using (var dbContext = new Sistema_TrazabilidadEntities())
                {
                    var Roles = (from _rol in dbContext.Apl_Roles
                                 where _rol.Empresa_ID == Empresa_ID &&
                                 ((Cls_Sesiones.Default_Admin_Empresa.ToUpper().Equals("S")) ? true : _rol.Sucursal_ID == Sucursal_ID)
                                 && _rol.Tipo == "WEB"
                                 select _rol).ToList();
                    Dt_Roles = ConvertToDataTable<Apl_Roles>(Roles);
                }
            }
            catch (Exception Ex)
            {
            ...
            try
            {
                    ...
                    Mi_Oracle = "SELECT " +
                               ...
                               Apl_Cat_Menus.Campo_Menu_Descripcion + ", " +
                                " 'NO' AS Habilitado FROM  " +
                                 ...
                                 Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa +
                               " WHERE " + Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa + "." + Apl_Menus_Empresas.Campo_Empresa_ID + " = " + Cls_Sesiones.Empresa_ID +
                               " AND " +
                                Apl_Cat_Menus.Tabla_Apl_Cat_Menus + "." + Apl_Cat_Menus.Campo_Menu_ID + " = " +
                                Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa + "." + Apl_Menus_Empresas.Campo_Menu_ID +
                ...
                else
                {
                    Mi_Oracle = "SELECT " +
                               ...
                               " AND" +
                                 Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa + "." + Apl_Menus_Empresas.Campo_Empresa_ID + " = " + Cls_Sesiones.Empresa_ID +
                                " AND " +
                                Apl_Cat_Menus.Tabla_Apl_Cat_Menus + "." + Apl_Cat_Menus.Campo_Menu_ID + " = " +
                                Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa + "." + Apl_Menus_Empresas.Campo_Menu_ID;
                }
        ...
        ///****************************************************************************************
        ///  NOMBRE DE LA FUNCION: Convertir resultado de consulta linq a dataTable
        ///  DESCRIPCION : 
        ///  PARAMETROS  : Datos:Lista de datos
        ...
        public static DataTable Consulta_Menus_Rol(Cls_Apl_Cat_Roles_Business Datos)
        {
            ...
            try
            {
                ...
                Mi_SQL.Append(Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa);

                Mi_SQL.Append(" WHERE ");
                Mi_SQL.Append(Apl_Cat_Menus.Tabla_Apl_Cat_Menus + "." + Apl_Cat_Menus.Campo_Menu_ID + " = ");
                Mi_SQL.Append(Apl_Cat_Accesos.Tabla_Apl_Cat_Accesos + "." + Apl_Cat_Accesos.Campo_Menu_ID);
                Mi_SQL.Append(" AND ");
                Mi_SQL.Append(Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa + "." + Apl_Menus_Empresas.Campo_Empresa_ID + " = " + Cls_Sesiones.Empresa_ID);
                Mi_SQL.Append(" AND ");
                Mi_SQL.Append(Apl_Cat_Menus.Tabla_Apl_Cat_Menus + "." + Apl_Cat_Menus.Campo_Menu_ID + " = ");
                Mi_SQL.Append(Apl_Menus_Empresas.Tabla_Apl_Menus_Empresa + "." + Apl_Menus_Empresas.Campo_Menu_ID);
                Mi_SQL.Append(" AND ");
        ...
        public static DataTable Consultar_Estatus()
        {
            ...
            Mi_SQL.Append("select Estatus_ID, Estatus from Tra_Cat_Estatus");
        ...
        public static DataTable Consultar_Sucursales()
        {
            StringBuilder Mi_SQL = new StringBuilder();
            DataTable Dt_Sucursales = null;
            int Empresa_ID = String.IsNullOrEmpty(Cls_Sesiones.Empresa_ID) ? -1 : Convert.ToInt32(Cls_Sesiones.Empresa_ID);

            Mi_SQL.Append("select Sucursal_ID, Nombre as Sucursal from dbo.Apl_Sucursales WHERE Empresa_ID=" + Empresa_ID);
            Dt_Sucursales = SqlHelper.ExecuteDataset(Cls_Constantes.Str_Conexion, CommandType.Text, Mi_SQL.ToString()).Tables[0];
