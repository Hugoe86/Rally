...
{
    public class Cls_JsonParamBindingAttribute : Attribute
    {

    }

    public class Cls_JsonParamBinding : HttpParameterBinding
    {
        ...
        public Cls_JsonParamBinding(HttpParameterDescriptor descriptor)
            : base(descriptor)
        {
        }
        ...
        {
            if (descriptor.ActionDescriptor.ControllerDescriptor.GetCustomAttributes<Cls_JsonParamBindingAttribute>().Count == 0
                && descriptor.ActionDescriptor.GetCustomAttributes<Cls_JsonParamBindingAttribute>().Count == 0)
                return null;
            ...
            {
                return new Cls_JsonParamBinding(descriptor);
            }
