<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Apl_Mostrar_Notificaciones.aspx.cs" Inherits="web_trazabilidad.Paginas.Paginas_Generales.Frm_Apl_Mostrar_Notificaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/bootstrap-table-contextmenu/bootstrap-table-contextmenu.min.js"></script>

    <%--<script src="../../Recursos/javascript/seguridad/Js_Apl_Mostrar_Notificaciones.js"></script>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        ...
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Mostrar todas las notificaciones</h3>
        </div>
