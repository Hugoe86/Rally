...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Ope_Actualizacion_Tiempos.aspx.cs" 
    Inherits="web_trazabilidad.Paginas.Operaciones.Frm_Ope_Actualizacion_Tiempos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/Operaciones/Actualizacion_Tiempos/Js_Ope_Actualizacion_Tiempos.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Actualizacion de tiempos en punto de control</h3>
        </div>
        <%-- --------------------------------------------------------------- --%>
