...
function _alta_menu() {
    ...
    try {
        ...
        Menus.Parent_ID = ($('#cmb_menus_parent').val() != null && $('#cmb_menus_parent').val() != undefined && $('#cmb_menus_parent').val() != '') ? $('#cmb_menus_parent').val() : null;
      
        Menus.Nombre_Mostrar = $('#txt_nombre').val();
        Menus.URL_LINK = ($('#txt_url_link').val() != null && $('#txt_url_link').val() != undefined && $('#txt_url_link').val() != '') ? $('#txt_url_link').val() : null;
        Menus.Orden = ($('#txt_orden').val() != null && $('#txt_orden').val() != undefined && $('#txt_orden').val() != '') ? $('#txt_orden').val() : null;
        Menus.Icono = ($('#txt_icono').val() != null && $('#txt_icono').val() != undefined && $('#txt_icono').val() != '') ? $('#txt_icono').val() : null;
